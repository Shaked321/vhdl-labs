...
SIGNAL \u1_SW_LAP|SIG_OUT~DUPLICATE_q\ : std_logic;
...
SIGNAL \u2|COUNT_CLEAR~1_combout\ : std_logic;
...
SIGNAL \u2|cnt_lap~combout\ : std_logic;
...
SIGNAL \u1_SW_LAP|ALT_INV_SIG_OUT~DUPLICATE_q\ : std_logic;
SIGNAL \u2|ALT_INV_COUNT_ENABLE~combout\ : std_logic;
SIGNAL \u2|ALT_INV_COUNT_CLEAR~combout\ : std_logic;
SIGNAL \u2|ALT_INV_cnt_lap~combout\ : std_logic;
...
SIGNAL \u2|ALT_INV_COUNT_CLEAR~1_combout\ : std_logic;
...
SIGNAL \u2|ALT_INV_cnt_lap~1_combout\ : std_logic;
...
\u1_SW_LAP|ALT_INV_SIG_OUT~DUPLICATE_q\ <= NOT \u1_SW_LAP|SIG_OUT~DUPLICATE_q\;
\u2|ALT_INV_COUNT_ENABLE~combout\ <= NOT \u2|COUNT_ENABLE~combout\;
\u2|ALT_INV_COUNT_CLEAR~combout\ <= NOT \u2|COUNT_CLEAR~combout\;
\u2|ALT_INV_cnt_lap~combout\ <= NOT \u2|cnt_lap~combout\;
...
\u2|ALT_INV_COUNT_CLEAR~1_combout\ <= NOT \u2|COUNT_CLEAR~1_combout\;
...
\u2|ALT_INV_cnt_lap~1_combout\ <= NOT \u2|cnt_lap~1_combout\;
...
-- pragma translate_on
PORT MAP (
	datad => \u1_SW_LAP|ALT_INV_sig_in_d\(2),
	dataf => \u1_SW_LAP|ALT_INV_sig_in_d\(3),
	combout => \u1_SW_LAP|SIG_OUT~0_combout\);

-- Location: FF_X58_Y2_N38
\u1_SW_LAP|SIG_OUT~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \u1_SW_LAP|SIG_OUT~DUPLICATE_q\);
...
-- pragma translate_on
PORT MAP (
	datac => \u1_SW_START_STOP|ALT_INV_sig_in_d\(3),
	datad => \u1_SW_START_STOP|ALT_INV_sig_in_d\(2),
...
-- Equation(s):
-- \u2|Selector4~0_combout\ = ( \u1_SW_CLEAR|SIG_OUT~q\ & ( (!\u2|pr_state.st_lap~q\ & (\u1_SW_START_STOP|SIG_OUT~q\ & !\u2|pr_state.st_count~q\)) ) ) # ( !\u1_SW_CLEAR|SIG_OUT~q\ & ( ((!\u1_SW_START_STOP|SIG_OUT~q\ & (\u2|pr_state.st_count~q\ & 
-- !\u1_SW_LAP|SIG_OUT~DUPLICATE_q\)) # (\u1_SW_START_STOP|SIG_OUT~q\ & (!\u2|pr_state.st_count~q\))) # (\u2|pr_state.st_lap~q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111110101110101011111010111010100100000001000000010000000100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \u1_SW_LAP|ALT_INV_SIG_OUT~DUPLICATE_q\,
	dataf => \u1_SW_CLEAR|ALT_INV_SIG_OUT~q\,
...
-- Equation(s):
-- \u2|nx_state.st_lap~0_combout\ = ( \u2|pr_state.st_count~q\ & ( \u1_SW_LAP|SIG_OUT~DUPLICATE_q\ ) )
...
-- Equation(s):
-- \u2|Selector3~0_combout\ = ( !\u1_SW_CLEAR|SIG_OUT~q\ & ( (!\u1_SW_START_STOP|SIG_OUT~q\ & (((\u2|pr_state.st_stop~q\)))) # (\u1_SW_START_STOP|SIG_OUT~q\ & (\u2|pr_state.st_count~q\ & (!\u1_SW_LAP|SIG_OUT~q\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000011011100000100001101110000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \u2|ALT_INV_pr_state.st_count~q\,
	datab => \u1_SW_START_STOP|ALT_INV_SIG_OUT~q\,
	datac => \u1_SW_LAP|ALT_INV_SIG_OUT~q\,
	datad => \u2|ALT_INV_pr_state.st_stop~q\,
	dataf => \u1_SW_CLEAR|ALT_INV_SIG_OUT~q\,
	combout => \u2|Selector3~0_combout\);

-- Location: FF_X58_Y2_N59
...
-- Location: LABCELL_X58_Y2_N0
\u2|COUNT_CLEAR~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u2|COUNT_CLEAR~1_combout\ = ( \u2|pr_state.st_stop~q\ ) # ( !\u2|pr_state.st_stop~q\ & ( \u2|pr_state.st_lap~q\ ) )
...
PORT MAP (
	...
	combout => \u2|COUNT_CLEAR~1_combout\);

-- Location: LABCELL_X58_Y2_N42
\u2|COUNT_CLEAR\ : cyclonev_lcell_comb
-- Equation(s):
-- \u2|COUNT_CLEAR~combout\ = ( \u2|COUNT_CLEAR~1_combout\ & ( \u2|pr_state.st_count~q\ & ( \u2|COUNT_CLEAR~combout\ ) ) ) # ( \u2|COUNT_CLEAR~1_combout\ & ( !\u2|pr_state.st_count~q\ & ( \u2|COUNT_CLEAR~combout\ ) ) ) # ( !\u2|COUNT_CLEAR~1_combout\ & ( 
...
PORT MAP (
	...
	datae => \u2|ALT_INV_COUNT_CLEAR~1_combout\,
	dataf => \u2|ALT_INV_pr_state.st_count~q\,
	combout => \u2|COUNT_CLEAR~combout\);

-- Location: LABCELL_X59_Y2_N51
...
-- pragma translate_on
PORT MAP (
	datad => \u3|ALT_INV_count\(5),
	dataf => \u3|ALT_INV_count\(6),
	combout => \u3|LessThan0~1_combout\);

-- Location: MLABCELL_X60_Y2_N27
\u3|LessThan0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u3|LessThan0~0_combout\ = ( !\u3|count\(10) & ( (!\u3|count\(11) & (!\u3|count\(12) & (!\u3|count\(14) & !\u3|count\(9)))) ) )
...
PORT MAP (
	...
	datac => \u3|ALT_INV_count\(14),
	datad => \u3|ALT_INV_count\(9),
	dataf => \u3|ALT_INV_count\(10),
	combout => \u3|LessThan0~0_combout\);

-- Location: MLABCELL_X60_Y2_N30
\u3|LessThan0~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \u3|LessThan0~2_combout\ = ( !\u3|count\(7) & ( \u3|count\(3) & ( (!\u3|count\(1)) # ((!\u3|count\(4)) # ((!\u3|count\(0)) # (!\u3|count\(2)))) ) ) ) # ( !\u3|count\(7) & ( !\u3|count\(3) ) )
...
PORT MAP (
	...
	datad => \u3|ALT_INV_count\(2),
	datae => \u3|ALT_INV_count\(7),
	dataf => \u3|ALT_INV_count\(3),
	combout => \u3|LessThan0~2_combout\);

-- Location: MLABCELL_X60_Y2_N54
\u3|count[7]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u3|count[7]~0_combout\ = ( \u3|PULSE~0_combout\ & ( \u3|LessThan0~2_combout\ & ( ((!\u3|LessThan0~0_combout\) # ((!\u3|LessThan0~1_combout\ & \u3|count\(8)))) # (\u2|COUNT_CLEAR~combout\) ) ) ) # ( !\u3|PULSE~0_combout\ & ( \u3|LessThan0~2_combout\ & ( 
-- \u2|COUNT_CLEAR~combout\ ) ) ) # ( \u3|PULSE~0_combout\ & ( !\u3|LessThan0~2_combout\ & ( ((!\u3|LessThan0~0_combout\) # (\u3|count\(8))) # (\u2|COUNT_CLEAR~combout\) ) ) ) # ( !\u3|PULSE~0_combout\ & ( !\u3|LessThan0~2_combout\ & ( 
-- \u2|COUNT_CLEAR~combout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101111101011111111101010101010101011111010111111101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \u2|ALT_INV_COUNT_CLEAR~combout\,
	datab => \u3|ALT_INV_LessThan0~1_combout\,
	datac => \u3|ALT_INV_LessThan0~0_combout\,
	datad => \u3|ALT_INV_count\(8),
	datae => \u3|ALT_INV_PULSE~0_combout\,
	dataf => \u3|ALT_INV_LessThan0~2_combout\,
	combout => \u3|count[7]~0_combout\);

-- Location: LABCELL_X58_Y2_N12
\u2|COUNT_ENABLE\ : cyclonev_lcell_comb
-- Equation(s):
-- \u2|COUNT_ENABLE~combout\ = ( \u2|pr_state.st_count~q\ & ( (!\u2|pr_state.st_lap~q\) # (\u2|COUNT_ENABLE~combout\) ) ) # ( !\u2|pr_state.st_count~q\ & ( (\u2|pr_state.st_lap~q\ & \u2|COUNT_ENABLE~combout\) ) )
...
PORT MAP (
	dataa => \u2|ALT_INV_pr_state.st_lap~q\,
	datad => \u2|ALT_INV_COUNT_ENABLE~combout\,
	dataf => \u2|ALT_INV_pr_state.st_count~q\,
...
-- Equation(s):
-- \u3|count[7]~1_combout\ = ( \u2|COUNT_CLEAR~combout\ ) # ( !\u2|COUNT_CLEAR~combout\ & ( \u2|COUNT_ENABLE~combout\ ) )
...
-- pragma translate_on
PORT MAP (
	datab => \u2|ALT_INV_COUNT_ENABLE~combout\,
	dataf => \u2|ALT_INV_COUNT_CLEAR~combout\,
...
-- Location: MLABCELL_X60_Y2_N0
\u3|PULSE~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u3|PULSE~0_combout\ = ( \u3|count\(14) & ( \u3|count\(15) & ( (\u3|count\(17) & (\u3|count\(18) & \u3|count\(16))) ) ) ) # ( !\u3|count\(14) & ( \u3|count\(15) & ( (\u3|count\(17) & (\u3|count\(18) & (\u3|count\(13) & \u3|count\(16)))) ) ) )
...
PORT MAP (
	...
	dataf => \u3|ALT_INV_count\(15),
	combout => \u3|PULSE~0_combout\);

-- Location: LABCELL_X59_Y2_N12
...
-- Location: MLABCELL_X60_Y2_N15
\u3|PULSE~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \u3|PULSE~2_combout\ = ( \u3|LessThan0~0_combout\ & ( \u3|count\(8) & ( (\u3|PULSE~0_combout\ & (\u3|PULSE~1_combout\ & ((!\u3|LessThan0~1_combout\) # (!\u3|LessThan0~2_combout\)))) ) ) ) # ( !\u3|LessThan0~0_combout\ & ( \u3|count\(8) & ( 
-- (\u3|PULSE~0_combout\ & \u3|PULSE~1_combout\) ) ) ) # ( !\u3|LessThan0~0_combout\ & ( !\u3|count\(8) & ( (\u3|PULSE~0_combout\ & \u3|PULSE~1_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000100010001000000000000000000010001000100010001000100010000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \u3|ALT_INV_PULSE~0_combout\,
	datab => \u3|ALT_INV_PULSE~1_combout\,
	datac => \u3|ALT_INV_LessThan0~1_combout\,
	datad => \u3|ALT_INV_LessThan0~2_combout\,
	datae => \u3|ALT_INV_LessThan0~0_combout\,
	dataf => \u3|ALT_INV_count\(8),
...
-- Location: LABCELL_X59_Y2_N24
\u4|hund_cnt_ones[2]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|hund_cnt_ones[2]~1_combout\ = ( \u2|COUNT_CLEAR~combout\ ) # ( !\u2|COUNT_CLEAR~combout\ & ( \u3|PULSE~q\ ) )
...
-- Location: LABCELL_X59_Y2_N33
\u4|hund_cnt_ones~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|hund_cnt_ones~0_combout\ = ( \u4|hund_cnt_ones\(3) & ( \u4|hund_cnt_ones\(1) & ( (!\u2|COUNT_CLEAR~combout\ & ((!\u4|hund_cnt_ones\(2)) # (!\u4|hund_cnt_ones\(0)))) ) ) ) # ( !\u4|hund_cnt_ones\(3) & ( \u4|hund_cnt_ones\(1) & ( 
-- (!\u2|COUNT_CLEAR~combout\ & (\u4|hund_cnt_ones\(2) & \u4|hund_cnt_ones\(0))) ) ) ) # ( \u4|hund_cnt_ones\(3) & ( !\u4|hund_cnt_ones\(1) & ( (!\u2|COUNT_CLEAR~combout\ & ((!\u4|hund_cnt_ones\(0)) # (\u4|hund_cnt_ones\(2)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000110011000000110000000000000011001100110011000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \u4|ALT_INV_hund_cnt_ones\(0),
	datae => \u4|ALT_INV_hund_cnt_ones\(3),
...
PORT MAP (
	dataa => \u2|ALT_INV_COUNT_CLEAR~combout\,
	datab => \u4|ALT_INV_hund_cnt_ones\(2),
...
PORT MAP (
	datab => \u2|ALT_INV_COUNT_CLEAR~combout\,
	datac => \u4|ALT_INV_hund_cnt_ones\(1),
...
-- Equation(s):
-- \u2|Selector1~0_combout\ = ( !\u2|cnt_lap~combout\ & ( \u2|pr_state.st_lap~q\ ) )
...
-- pragma translate_on
PORT MAP (
	datab => \u2|ALT_INV_pr_state.st_lap~q\,
	dataf => \u2|ALT_INV_cnt_lap~combout\,
	combout => \u2|Selector1~0_combout\);

-- Location: LABCELL_X58_Y2_N48
\u2|cnt_lap~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u2|cnt_lap~1_combout\ = ( \u2|pr_state.st_count~q\ ) # ( !\u2|pr_state.st_count~q\ & ( \u2|pr_state.st_stop~q\ ) )
...
-- pragma translate_on
PORT MAP (
	datab => \u2|ALT_INV_pr_state.st_stop~q\,
	dataf => \u2|ALT_INV_pr_state.st_count~q\,
	combout => \u2|cnt_lap~1_combout\);

-- Location: LABCELL_X58_Y2_N21
\u2|cnt_lap\ : cyclonev_lcell_comb
-- Equation(s):
-- \u2|cnt_lap~combout\ = ( \u2|cnt_lap~1_combout\ & ( \u2|cnt_lap~combout\ ) ) # ( !\u2|cnt_lap~1_combout\ & ( \u2|Selector1~0_combout\ ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \u2|ALT_INV_cnt_lap~combout\,
	datac => \u2|ALT_INV_Selector1~0_combout\,
	dataf => \u2|ALT_INV_cnt_lap~1_combout\,
	combout => \u2|cnt_lap~combout\);
...
PORT MAP (
	...
	clrn => \RSTn~input_o\,
	sload => VCC,
	ena => \u2|ALT_INV_cnt_lap~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \u4|HUND_ONES\(2));
...
-- Equation(s):
-- \u5_HUND_ONES_7SEG|D_OUT[0]~0_combout\ = ( \u4|HUND_ONES\(1) & ( \u4|HUND_ONES\(3) ) ) # ( !\u4|HUND_ONES\(1) & ( !\u4|HUND_ONES\(2) $ (((!\u4|HUND_ONES\(0)) # (\u4|HUND_ONES\(3)))) ) )
...
-- Equation(s):
-- \u5_HUND_ONES_7SEG|D_OUT[1]~1_combout\ = ( \u4|HUND_ONES\(1) & ( ((\u4|HUND_ONES\(2) & !\u4|HUND_ONES\(0))) # (\u4|HUND_ONES\(3)) ) ) # ( !\u4|HUND_ONES\(1) & ( (\u4|HUND_ONES\(2) & ((\u4|HUND_ONES\(0)) # (\u4|HUND_ONES\(3)))) ) )
...
-- Equation(s):
-- \u5_HUND_ONES_7SEG|D_OUT[2]~2_combout\ = ( \u4|HUND_ONES\(1) & ( ((!\u4|HUND_ONES\(0) & !\u4|HUND_ONES\(2))) # (\u4|HUND_ONES\(3)) ) ) # ( !\u4|HUND_ONES\(1) & ( (\u4|HUND_ONES\(2) & \u4|HUND_ONES\(3)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000001111000000000000111111000000111111111100000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \u4|ALT_INV_HUND_ONES\(0),
	datac => \u4|ALT_INV_HUND_ONES\(2),
	datad => \u4|ALT_INV_HUND_ONES\(3),
	dataf => \u4|ALT_INV_HUND_ONES\(1),
...
-- Equation(s):
-- \u5_HUND_ONES_7SEG|D_OUT[3]~3_combout\ = ( \u4|HUND_ONES\(1) & ( ((\u4|HUND_ONES\(2) & \u4|HUND_ONES\(0))) # (\u4|HUND_ONES\(3)) ) ) # ( !\u4|HUND_ONES\(1) & ( !\u4|HUND_ONES\(2) $ (((!\u4|HUND_ONES\(0)) # (\u4|HUND_ONES\(3)))) ) )
...
-- Equation(s):
-- \u5_HUND_ONES_7SEG|D_OUT[4]~4_combout\ = ((!\u4|HUND_ONES\(1) & (\u4|HUND_ONES\(2))) # (\u4|HUND_ONES\(1) & ((\u4|HUND_ONES\(3))))) # (\u4|HUND_ONES\(0))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111011100111111011101110011111101110111001111110111011100111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \u4|ALT_INV_HUND_ONES\(2),
	datab => \u4|ALT_INV_HUND_ONES\(0),
	datac => \u4|ALT_INV_HUND_ONES\(3),
...
-- Equation(s):
-- \u5_HUND_ONES_7SEG|D_OUT[5]~5_combout\ = ( \u4|HUND_ONES\(1) & ( ((!\u4|HUND_ONES\(2)) # (\u4|HUND_ONES\(0))) # (\u4|HUND_ONES\(3)) ) ) # ( !\u4|HUND_ONES\(1) & ( (!\u4|HUND_ONES\(3) & (!\u4|HUND_ONES\(2) & \u4|HUND_ONES\(0))) # (\u4|HUND_ONES\(3) & 
-- (\u4|HUND_ONES\(2))) ) )
...
-- Location: LABCELL_X59_Y2_N3
\u5_HUND_ONES_7SEG|D_OUT[6]~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_HUND_ONES_7SEG|D_OUT[6]~6_combout\ = ( \u4|HUND_ONES\(1) & ( ((\u4|HUND_ONES\(2) & \u4|HUND_ONES\(0))) # (\u4|HUND_ONES\(3)) ) ) # ( !\u4|HUND_ONES\(1) & ( !\u4|HUND_ONES\(2) $ (\u4|HUND_ONES\(3)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010101001010101101010100101010100000101111111110000010111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \u4|ALT_INV_HUND_ONES\(2),
...
-- Location: LABCELL_X59_Y2_N54
\u4|hund_cnt_tens[3]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|hund_cnt_tens[3]~1_combout\ = ( \u3|PULSE~q\ & ( \u2|COUNT_CLEAR~combout\ ) ) # ( !\u3|PULSE~q\ & ( \u2|COUNT_CLEAR~combout\ ) ) # ( \u3|PULSE~q\ & ( !\u2|COUNT_CLEAR~combout\ & ( (\u4|hund_cnt_ones\(0) & (!\u4|hund_cnt_ones\(1) & 
-- (\u4|hund_cnt_ones\(3) & !\u4|hund_cnt_ones\(2)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000001000000000011111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \u4|ALT_INV_hund_cnt_ones\(0),
	datab => \u4|ALT_INV_hund_cnt_ones\(1),
	datac => \u4|ALT_INV_hund_cnt_ones\(3),
	datad => \u4|ALT_INV_hund_cnt_ones\(2),
...
-- Location: LABCELL_X59_Y2_N9
\u4|hund_cnt_tens~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|hund_cnt_tens~3_combout\ = ( \u4|hund_cnt_tens\(0) & ( (!\u2|COUNT_CLEAR~combout\ & (!\u4|hund_cnt_tens\(1) & ((!\u4|hund_cnt_tens\(3)) # (\u4|hund_cnt_tens\(2))))) ) ) # ( !\u4|hund_cnt_tens\(0) & ( (!\u2|COUNT_CLEAR~combout\ & \u4|hund_cnt_tens\(1)) 
-- ) )
...
PORT MAP (
	...
	datab => \u2|ALT_INV_COUNT_CLEAR~combout\,
	datac => \u4|ALT_INV_hund_cnt_tens\(3),
	datad => \u4|ALT_INV_hund_cnt_tens\(1),
	dataf => \u4|ALT_INV_hund_cnt_tens\(0),
...
-- Location: LABCELL_X59_Y2_N27
\u4|hund_cnt_tens~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|hund_cnt_tens~2_combout\ = ( \u4|hund_cnt_tens\(0) & ( (!\u2|COUNT_CLEAR~combout\ & (!\u4|hund_cnt_tens\(1) $ (!\u4|hund_cnt_tens\(2)))) ) ) # ( !\u4|hund_cnt_tens\(0) & ( (!\u2|COUNT_CLEAR~combout\ & \u4|hund_cnt_tens\(2)) ) )
...
-- Location: LABCELL_X59_Y2_N6
\u4|hund_cnt_tens~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|hund_cnt_tens~0_combout\ = ( \u4|hund_cnt_tens\(1) & ( (!\u2|COUNT_CLEAR~combout\ & (!\u4|hund_cnt_tens\(3) $ (((!\u4|hund_cnt_tens\(2)) # (!\u4|hund_cnt_tens\(0)))))) ) ) # ( !\u4|hund_cnt_tens\(1) & ( (!\u2|COUNT_CLEAR~combout\ & 
-- (\u4|hund_cnt_tens\(3) & ((!\u4|hund_cnt_tens\(0)) # (\u4|hund_cnt_tens\(2))))) ) )
...
PORT MAP (
	...
	dataf => \u4|ALT_INV_hund_cnt_tens\(1),
...
-- Equation(s):
-- \u5_HUND_TENS_7SEG|D_OUT[0]~0_combout\ = ( \u4|HUND_TENS\(1) & ( \u4|HUND_TENS\(3) ) ) # ( !\u4|HUND_TENS\(1) & ( !\u4|HUND_TENS\(2) $ (((!\u4|HUND_TENS\(0)) # (\u4|HUND_TENS\(3)))) ) )
...
PORT MAP (
	...
	dataf => \u4|ALT_INV_HUND_TENS\(1),
	combout => \u5_HUND_TENS_7SEG|D_OUT[0]~0_combout\);

-- Location: LABCELL_X63_Y2_N30
\u5_HUND_TENS_7SEG|D_OUT[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_HUND_TENS_7SEG|D_OUT[1]~1_combout\ = ( \u4|HUND_TENS\(0) & ( (!\u4|HUND_TENS\(1) & ((\u4|HUND_TENS\(2)))) # (\u4|HUND_TENS\(1) & (\u4|HUND_TENS\(3))) ) ) # ( !\u4|HUND_TENS\(0) & ( (!\u4|HUND_TENS\(1) & (\u4|HUND_TENS\(3) & \u4|HUND_TENS\(2))) # 
-- (\u4|HUND_TENS\(1) & ((\u4|HUND_TENS\(2)) # (\u4|HUND_TENS\(3)))) ) )
...
-- Equation(s):
-- \u5_HUND_TENS_7SEG|D_OUT[2]~2_combout\ = ( \u4|HUND_TENS\(1) & ( ((!\u4|HUND_TENS\(0) & !\u4|HUND_TENS\(2))) # (\u4|HUND_TENS\(3)) ) ) # ( !\u4|HUND_TENS\(1) & ( (\u4|HUND_TENS\(3) & \u4|HUND_TENS\(2)) ) )
...
PORT MAP (
	dataa => \u4|ALT_INV_HUND_TENS\(3),
	datab => \u4|ALT_INV_HUND_TENS\(0),
	datac => \u4|ALT_INV_HUND_TENS\(2),
	dataf => \u4|ALT_INV_HUND_TENS\(1),
...
-- Equation(s):
-- \u5_HUND_TENS_7SEG|D_OUT[3]~3_combout\ = ( \u4|HUND_TENS\(1) & ( ((\u4|HUND_TENS\(0) & \u4|HUND_TENS\(2))) # (\u4|HUND_TENS\(3)) ) ) # ( !\u4|HUND_TENS\(1) & ( !\u4|HUND_TENS\(2) $ (((!\u4|HUND_TENS\(0)) # (\u4|HUND_TENS\(3)))) ) )
...
-- Equation(s):
-- \u5_HUND_TENS_7SEG|D_OUT[4]~4_combout\ = ((!\u4|HUND_TENS\(1) & ((\u4|HUND_TENS\(2)))) # (\u4|HUND_TENS\(1) & (\u4|HUND_TENS\(3)))) # (\u4|HUND_TENS\(0))
...
-- Equation(s):
-- \u5_HUND_TENS_7SEG|D_OUT[5]~5_combout\ = ( \u4|HUND_TENS\(0) & ( (!\u4|HUND_TENS\(2) $ (\u4|HUND_TENS\(3))) # (\u4|HUND_TENS\(1)) ) ) # ( !\u4|HUND_TENS\(0) & ( (!\u4|HUND_TENS\(2) & ((\u4|HUND_TENS\(1)))) # (\u4|HUND_TENS\(2) & (\u4|HUND_TENS\(3))) ) )
...
-- Equation(s):
-- \u5_HUND_TENS_7SEG|D_OUT[6]~6_combout\ = ( \u4|HUND_TENS\(1) & ( ((\u4|HUND_TENS\(2) & \u4|HUND_TENS\(0))) # (\u4|HUND_TENS\(3)) ) ) # ( !\u4|HUND_TENS\(1) & ( !\u4|HUND_TENS\(2) $ (\u4|HUND_TENS\(3)) ) )
...
-- Location: LABCELL_X59_Y2_N18
\u4|Equal0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|Equal0~0_combout\ = ( !\u4|hund_cnt_ones\(1) & ( (\u4|hund_cnt_ones\(0) & (\u4|hund_cnt_ones\(3) & !\u4|hund_cnt_ones\(2))) ) )
...
-- Location: LABCELL_X59_Y2_N0
\u4|Equal1~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|Equal1~0_combout\ = ( !\u4|hund_cnt_tens\(1) & ( (\u4|hund_cnt_tens\(0) & (!\u4|hund_cnt_tens\(2) & \u4|hund_cnt_tens\(3))) ) )
...
-- Location: MLABCELL_X60_Y2_N51
\u4|sec_cnt_ones~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|sec_cnt_ones~3_combout\ = ( \u4|sec_cnt_ones\(3) & ( (!\u2|COUNT_CLEAR~combout\ & ((!\u4|sec_cnt_ones\(0) & ((\u4|sec_cnt_ones\(1)))) # (\u4|sec_cnt_ones\(0) & (\u4|sec_cnt_ones\(2) & !\u4|sec_cnt_ones\(1))))) ) ) # ( !\u4|sec_cnt_ones\(3) & ( 
-- (!\u2|COUNT_CLEAR~combout\ & (!\u4|sec_cnt_ones\(0) $ (!\u4|sec_cnt_ones\(1)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000101010100000000010101010000000000010101000000000001010100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \u2|ALT_INV_COUNT_CLEAR~combout\,
	...
	dataf => \u4|ALT_INV_sec_cnt_ones\(3),
...
-- Location: LABCELL_X58_Y2_N9
\u5_SEC_ONES_7SEG|D_OUT[0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_SEC_ONES_7SEG|D_OUT[0]~0_combout\ = ( \u4|SEC_ONES\(2) & ( ((!\u4|SEC_ONES\(1) & !\u4|SEC_ONES\(0))) # (\u4|SEC_ONES\(3)) ) ) # ( !\u4|SEC_ONES\(2) & ( (!\u4|SEC_ONES\(1) & (!\u4|SEC_ONES\(3) & \u4|SEC_ONES\(0))) # (\u4|SEC_ONES\(1) & 
-- (\u4|SEC_ONES\(3))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \u4|ALT_INV_SEC_ONES\(1),
	datab => \u4|ALT_INV_SEC_ONES\(3),
	datac => \u4|ALT_INV_SEC_ONES\(0),
	dataf => \u4|ALT_INV_SEC_ONES\(2),
	combout => \u5_SEC_ONES_7SEG|D_OUT[0]~0_combout\);

-- Location: LABCELL_X58_Y2_N6
\u5_SEC_ONES_7SEG|D_OUT[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_SEC_ONES_7SEG|D_OUT[1]~1_combout\ = ( \u4|SEC_ONES\(2) & ( (!\u4|SEC_ONES\(1) $ (!\u4|SEC_ONES\(0))) # (\u4|SEC_ONES\(3)) ) ) # ( !\u4|SEC_ONES\(2) & ( (\u4|SEC_ONES\(1) & \u4|SEC_ONES\(3)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000100010001000100010001000101111011011110110111101101111011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \u4|ALT_INV_SEC_ONES\(1),
...
-- Location: LABCELL_X58_Y2_N39
\u5_SEC_ONES_7SEG|D_OUT[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_SEC_ONES_7SEG|D_OUT[2]~2_combout\ = ( \u4|SEC_ONES\(2) & ( \u4|SEC_ONES\(3) ) ) # ( !\u4|SEC_ONES\(2) & ( (\u4|SEC_ONES\(1) & ((!\u4|SEC_ONES\(0)) # (\u4|SEC_ONES\(3)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000101100001011000010110000101100110011001100110011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Location: LABCELL_X59_Y2_N21
\u5_SEC_ONES_7SEG|D_OUT[3]~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_SEC_ONES_7SEG|D_OUT[3]~3_combout\ = ( \u4|SEC_ONES\(2) & ( (!\u4|SEC_ONES\(1) $ (\u4|SEC_ONES\(0))) # (\u4|SEC_ONES\(3)) ) ) # ( !\u4|SEC_ONES\(2) & ( (!\u4|SEC_ONES\(3) & (!\u4|SEC_ONES\(1) & \u4|SEC_ONES\(0))) # (\u4|SEC_ONES\(3) & 
-- (\u4|SEC_ONES\(1))) ) )
...
-- Location: LABCELL_X59_Y2_N15
\u5_SEC_ONES_7SEG|D_OUT[4]~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_SEC_ONES_7SEG|D_OUT[4]~4_combout\ = ( \u4|SEC_ONES\(2) & ( ((!\u4|SEC_ONES\(1)) # (\u4|SEC_ONES\(3))) # (\u4|SEC_ONES\(0)) ) ) # ( !\u4|SEC_ONES\(2) & ( ((\u4|SEC_ONES\(1) & \u4|SEC_ONES\(3))) # (\u4|SEC_ONES\(0)) ) )
...
PORT MAP (
	dataa => \u4|ALT_INV_SEC_ONES\(0),
	datab => \u4|ALT_INV_SEC_ONES\(1),
	datac => \u4|ALT_INV_SEC_ONES\(3),
	dataf => \u4|ALT_INV_SEC_ONES\(2),
	combout => \u5_SEC_ONES_7SEG|D_OUT[4]~4_combout\);

-- Location: LABCELL_X59_Y2_N42
\u5_SEC_ONES_7SEG|D_OUT[5]~5\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_SEC_ONES_7SEG|D_OUT[5]~5_combout\ = ( \u4|SEC_ONES\(2) & ( ((\u4|SEC_ONES\(1) & \u4|SEC_ONES\(0))) # (\u4|SEC_ONES\(3)) ) ) # ( !\u4|SEC_ONES\(2) & ( ((\u4|SEC_ONES\(0) & !\u4|SEC_ONES\(3))) # (\u4|SEC_ONES\(1)) ) )
...
PORT MAP (
	dataa => \u4|ALT_INV_SEC_ONES\(1),
	datac => \u4|ALT_INV_SEC_ONES\(0),
	datad => \u4|ALT_INV_SEC_ONES\(3),
	dataf => \u4|ALT_INV_SEC_ONES\(2),
	combout => \u5_SEC_ONES_7SEG|D_OUT[5]~5_combout\);

-- Location: LABCELL_X59_Y2_N36
\u5_SEC_ONES_7SEG|D_OUT[6]~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_SEC_ONES_7SEG|D_OUT[6]~6_combout\ = ( \u4|SEC_ONES\(2) & ( ((\u4|SEC_ONES\(0) & \u4|SEC_ONES\(1))) # (\u4|SEC_ONES\(3)) ) ) # ( !\u4|SEC_ONES\(2) & ( !\u4|SEC_ONES\(3) $ (\u4|SEC_ONES\(1)) ) )
...
-- Location: MLABCELL_X60_Y2_N21
\u4|Equal2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|Equal2~0_combout\ = ( \u4|sec_cnt_ones\(3) & ( (!\u4|sec_cnt_ones\(1) & (!\u4|sec_cnt_ones\(2) & \u4|sec_cnt_ones\(0))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \u4|ALT_INV_sec_cnt_ones\(1),
	datac => \u4|ALT_INV_sec_cnt_ones\(2),
	datad => \u4|ALT_INV_sec_cnt_ones\(0),
	dataf => \u4|ALT_INV_sec_cnt_ones\(3),
	combout => \u4|Equal2~0_combout\);

-- Location: MLABCELL_X60_Y2_N36
\u4|sec_cnt_tens[0]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u4|sec_cnt_tens[0]~1_combout\ = ( \u4|Equal1~0_combout\ & ( ((\u3|PULSE~q\ & (\u4|Equal2~0_combout\ & \u4|Equal0~0_combout\))) # (\u2|COUNT_CLEAR~combout\) ) ) # ( !\u4|Equal1~0_combout\ & ( \u2|COUNT_CLEAR~combout\ ) )
...
-- Equation(s):
-- \u5_SEC_TENS_7SEG|D_OUT[0]~0_combout\ = ( \u4|SEC_TENS\(2) & ( (!\u4|SEC_TENS\(1) & !\u4|SEC_TENS\(0)) ) ) # ( !\u4|SEC_TENS\(2) & ( (!\u4|SEC_TENS\(1) & \u4|SEC_TENS\(0)) ) )
...
PORT MAP (
	...
	dataf => \u4|ALT_INV_SEC_TENS\(2),
	combout => \u5_SEC_TENS_7SEG|D_OUT[0]~0_combout\);

-- Location: LABCELL_X63_Y2_N45
\u5_SEC_TENS_7SEG|D_OUT[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_SEC_TENS_7SEG|D_OUT[1]~1_combout\ = ( \u4|SEC_TENS\(1) & ( (!\u4|SEC_TENS\(0) & \u4|SEC_TENS\(2)) ) ) # ( !\u4|SEC_TENS\(1) & ( (\u4|SEC_TENS\(0) & \u4|SEC_TENS\(2)) ) )
...
-- Equation(s):
-- \u5_SEC_TENS_7SEG|D_OUT[2]~2_combout\ = ( !\u4|SEC_TENS\(2) & ( (\u4|SEC_TENS\(1) & !\u4|SEC_TENS\(0)) ) )
...
-- Equation(s):
-- \u5_SEC_TENS_7SEG|D_OUT[3]~3_combout\ = ( \u4|SEC_TENS\(0) & ( !\u4|SEC_TENS\(2) $ (\u4|SEC_TENS\(1)) ) ) # ( !\u4|SEC_TENS\(0) & ( (\u4|SEC_TENS\(2) & !\u4|SEC_TENS\(1)) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \u4|ALT_INV_SEC_TENS\(2),
	datac => \u4|ALT_INV_SEC_TENS\(1),
	dataf => \u4|ALT_INV_SEC_TENS\(0),
	combout => \u5_SEC_TENS_7SEG|D_OUT[3]~3_combout\);

-- Location: LABCELL_X63_Y2_N24
\u5_SEC_TENS_7SEG|D_OUT[4]~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \u5_SEC_TENS_7SEG|D_OUT[4]~4_combout\ = ( \u4|SEC_TENS\(0) ) # ( !\u4|SEC_TENS\(0) & ( (\u4|SEC_TENS\(2) & !\u4|SEC_TENS\(1)) ) )
...
-- Equation(s):
-- \u5_SEC_TENS_7SEG|D_OUT[5]~5_combout\ = (!\u4|SEC_TENS\(1) & ((!\u4|SEC_TENS\(0)) # (\u4|SEC_TENS\(2)))) # (\u4|SEC_TENS\(1) & (\u4|SEC_TENS\(2) & !\u4|SEC_TENS\(0)))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010111100001010101011110000101010101111000010101010111100001010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \u4|ALT_INV_SEC_TENS\(1),
...
-- Equation(s):
-- \u5_SEC_TENS_7SEG|D_OUT[6]~6_combout\ = ( \u4|SEC_TENS\(0) & ( !\u4|SEC_TENS\(1) $ (\u4|SEC_TENS\(2)) ) ) # ( !\u4|SEC_TENS\(0) & ( (!\u4|SEC_TENS\(1) & !\u4|SEC_TENS\(2)) ) )
