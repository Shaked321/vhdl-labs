...
port (
    ...
    SIG_OUT         : out   std_logic:='0'   -- synced & derivative output
);
end entity;

architecture behave of sync_diff is

    signal sig_in_d     : std_logic_vector(3 downto 1) := (others=>SIG_IN_INIT_VALUE);
...
begin
    ...
    begin
        if RST = '0' then
            sig_in_d <= (others=>SIG_IN_INIT_VALUE);
            SIG_OUT <= '0';
